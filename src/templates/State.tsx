...
export const getHeadConfig: GetHeadConfig<TemplateRenderProps> = ({
  ...
  return {
    title: `${document.c_meta_title?document.c_meta_title:`Independent Financial  in ${document.name} | Find a Local Financial`}`,
    charset: "UTF-8",
    ...
    tags: [
      {
      ...
      },
        {
          ...
          attributes: {
            name: "description",
            content:`${document.c_meta_description?document.c_meta_description:`Use this page to find your nearest IndependentFinancial in ${document.name} and discover the location details you need to visit us today.`}`,
          },
        },
