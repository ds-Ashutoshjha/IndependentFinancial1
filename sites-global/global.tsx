export const stagingBaseurl = "https://master-loosely--total--bobcat-sbx-pgsdemo-com.sbx.preview.pagescdn.com/";
...
export const favicon="https://s.yimg.com/ny/api/res/1.2/y1BUSoA1TiTJcn.NvyGCeA--/YXBwaWQ9aGlnaGxhbmRlcjt3PTY0MDtoPTE1MA--/https://www.accesswire.com/users/newswire/images/547347/independent%20pic%20logo.PNG";
...
export const center_latitude=30.55435;
export const center_longitude=-91.03677;
...
<path d="M877,4760h5a1,1,0,0,0,1-1v-8.59l.293.3a1,1,0,1,0,1.414-1.42l-9-9a1,1,0,0,0-1.414,0l-9,9a1,1,0,0,0,1.414,1.42l.293-.3V4759a1,1,0,0,0,1,1h5a1,1,0,0,0,1-1v-5h2v5A1,1,0,0,0,877,4760Zm4-2h-3v-5a1,1,0,0,0-1-1h-4a1,1,0,0,0-1,1v5h-3v-9.59l6-6,6,6Z" transform="translate(-865 -4739.998)" fill="#d34d38" fill-rule="evenodd"/>
</svg>`;
...
<g transform="translate(-1106.871 -1030.805)">
  <path d="M14.534,42.324C2.275,24.553,0,22.729,0,16.2a16.2,16.2,0,0,1,32.4,0c0,6.531-2.275,8.355-14.534,26.126a2.026,2.026,0,0,1-3.329,0ZM16.2,22.947A6.749,6.749,0,1,0,9.449,16.2,6.749,6.749,0,0,0,16.2,22.947Z" transform="translate(1106.871 1030.805)" fill="#d34d38" />
  <g transform="translate(154 186.171)">
    ...
    <text id="M" transform="translate(961.267 867.509)" fill="#d34d38" font-size="16" font-family="SofiaProLight, Sofia Pro"><tspan x="0" y="0">M</tspan></text>
  </g>
</g>
</svg>`;
